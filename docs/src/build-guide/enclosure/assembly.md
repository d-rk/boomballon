...
- Assembly STEP: [`180129_bb_device_cpl_asm.stp`](https://github.com/d-rk/boomballon/blob/main/hardware/enclosure/step/180129_bb_device_cpl_asm.stp)
- Individual part STLs/STEPs: see each part page, or
...
(the `assembly` target loads all three parts).
