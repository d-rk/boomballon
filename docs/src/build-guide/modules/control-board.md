...
| TIP120 Darlington transistor | 2 | STM (Reichelt) | [PDF](https://github.com/boomballoon/boomballoon.github.io/blob/main/hardware/datasheets/TIP120_TIP121_TIP122_TIP125_TIP126_TIP127%23STM.pdf) |
| 1N4004 flyback diode | 2 | Fairchild | [PDF](https://github.com/boomballoon/boomballoon.github.io/blob/main/hardware/datasheets/1N400x_FAI.pdf) |
| 2.2 kΩ resistor (metal film) | 2 | Reichelt METALL 2,20K, transistor base | [PDF](https://github.com/boomballoon/boomballoon.github.io/blob/main/hardware/datasheets/METALL%23YAG.pdf) |
...
| Component | Qty | Part / supplier | Datasheet |
|---|---|---|---|
| DC socket (switched) | 1 | BKL 072342 | [PDF](https://github.com/boomballoon/boomballoon.github.io/blob/main/hardware/datasheets/072342.pdf) |
| Toggle switch (on/off) | 1 | MS-165 series | [PDF](https://github.com/boomballoon/boomballoon.github.io/blob/main/hardware/datasheets/MS-165_169.pdf) |
| Membrane pump (inflate) | 1 | AIRPO D2028B (12 V) | [PDF](https://github.com/boomballoon/boomballoon.github.io/blob/main/hardware/datasheets/AIRPO%20D2028B.pdf) |
| Solenoid valve (deflate) | 1 | CEME 5000EN1,5P | [PDF](https://github.com/boomballoon/boomballoon.github.io/blob/main/hardware/datasheets/Druckluft-Magnetventil%20CEME%205000EN1%2C5P.pdf) |
...
[`Motorsteuerung.pdf`](https://github.com/boomballoon/boomballoon.github.io/blob/main/hardware/control/Motorsteuerung.pdf).
...
Fritzing source:
[`Steuermodul.fzz`](https://github.com/boomballoon/boomballoon.github.io/blob/main/hardware/control/Steuermodul.fzz).
